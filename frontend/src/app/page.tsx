  ...
  return (
    <div className="min-h-screen flex flex-col items-center px-5 py-12">
      ...
      <div ref={contentRef} className="relative w-full max-w-2xl mb-8">
        ...
        {/* Upload for crash analysis */}
        <div
          className="w-full fade-up mt-3"
          style={{ animationDelay: "0.70s" }}
        >
          <DuoButton variant="green" fullWidth onClick={() => router.push("/crash-analysis")}>
            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="mr-2"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="17 8 12 3 7 8"/><line x1="12" y1="3" x2="12" y2="15"/></svg>
            Upload for Crash Analysis
          </DuoButton>
        </div>
